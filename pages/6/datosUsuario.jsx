...
const view6 = () => {
    return (
        <>
                ...
                <h1 className="text-center text-2xl p-4 font-bold text-[#2F4F4F]">¡Cuentanos un poco de ti!</h1>
                <h3 className="text-center text-[#2F4F4F] px-4 pb-10">Para personalizar tu perfil te pedimos que respondas los siguientes campos</h3>
