      ...
      <div className='w-full h-full lg:w-2/3 flex flex-col text-[#2F4F4F] mt-2 '>
        <div className='flex flex-col text-center '>
          ...
          <div className='w-full h-full flex flex-col justify-center items-center font-semibold text-sm md:text-base lg:text-xl'>
              ...
              <p className='mt-6'>
                En AccesoGo, invitamos a todas las empresas a unirse a esta
                causa importante y a marcar una diferencia real en la vida de
                muchas personas Regístrate y elige entre dos opciones de perfil:
              </p>
              ...
              <ol>
                <li className='mt-6'>
                  Todo lo del perfil Gratuito más: Mayor Visibilidad:
                  Herramientas avanzadas para destacarte.
                </li>
                <li className='mt-6'>
          ...
          <div className='flex flex-col text-center mt-8 text-sm md:text-base lg:text-xl'>
            ...
            <p className='mt-6'>
              En caso de ser detectada información falsa en el registro de
              alguna cuenta Premium dicha cuenta podria ser cancelada.
            </p>
            <p className='mt-6'>
              Si tu estableciento o negocio no cuenta con la infraestructura que
              registraste al crear tu cuenta premium te pediremos que
              rectifiques la información.
            </p>
            <p className='mt-6'>
        ...
        <div className='flex flex-row justify-between items center mt-10'>
          <button className='w-[155px] lg:w-[200px] h-[40px] lg:h-[50px] border-2 rounded-lg'>
            Cancelar
          </button>
          <button className='w-[155px] lg:w-[200px] h-[40px] lg:h-[50px] bg-[#2F4F4F] text-white rounded-lg'>
            Continuar
          </button>
        </div>
      </div>
