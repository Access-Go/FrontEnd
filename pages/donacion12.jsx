...
export default function Donacion() {
  return (
    <Layout>
      <div className='w-full h-full flex flex-col justify-center items-center lg:p-16 '>
        <div className='text-[#2F4F4F] text-center'>
          ...
          <p className='text-sm mt-6 md:text-xl lg:text-xl '>
            ...
            información sobre la accesibilidad en establecimientos para que
            todos puedan disfrutar de espacios inclusivos y cómodos. Tu apoyo es
        ...
        <div className='w-full h-full flex flex-col lg:flex-row justify-center items-center mt-8'>
          <div className='bg-gray-100 rounded-xl w-full h-full flex flex-col justify-center items-center '>
            <button className='w-[194px] h-[50px] bg-[#2F4F4F] text-white mt-6 rounded-xl'>
              <img src='' alt='' />
              Tarjeta de crédito
            </button>
            <input
              className='text-sm mt-8 border-b border-black w-2/3 '
              type='text'
              placeholder='Banco'
            />
            <input
            ...
            />
            <input
              className='text-sm mt-8 border-b border-black w-1/3'
              type='text'
              placeholder='MM/AA'
            />
            <input
              ...
              placeholder='CVV'
            />
            <button className='w-[111px] h-[30px] bg-[#2F4F4F] rounded-xl mt-4 mb-6 grid grid-cols-5 text-white items-center'>
              <img
          ...
          <div className=' w-full h-full flex flex-col justify-center items-center lg:ml-8 '>
            <div className='bg-[#2F4F4F] text-center text-white rounded-xl mt-8 p-4'>
              <p className='text-base font-semibold md:text-xl lg:text-2xl'>
                Tu donativo nos permitirá:{' '}
              </p>
              <ul>
                <li className='text-sm mt-6 md:text-base lg:text-base '>
                  Actualizar la base de datos con la información más reciente.
                  Mejorar las funcionalidades del sitio para ofrecer una
                  experiencia más fluída. Garantizar el mantenimiento y la
                  seguradad de la página.
                </li>
              </ul>
            </div>
