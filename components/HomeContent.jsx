    ...
    return (
      <div className="flex flex-col text-[#2F4F4F] font-sans"> 
        ...
        <div className="flex flex-col md:flex-row p-4 text-[#2F4F4F]">
          <div className="md:w-[566px] md:ml-[80px] mb-4 mt-[40px] md:mb-0">
          ...
          <div className="flex flex-row md:w-[633px] ml-[63px] mb-4 md:mb-0">
          <div className="flex flex-col ml-[65px] mt-[48px] absolute transform rotate-[-10deg] translate-x-[-40px] bg-[#2F4F4F] w-[106px] h-[187px] rounded-lg shadow-lg z-20">
              <div className="w-[98px] h-[140px] m-1 mb-3 flex items-center justify-center">
                <img 
                  src="/en la sala.svg" 
                  alt="imagen 1" 
            ...
            <div className="flex flex-col mt-[70px] ml-[120px] absolute bg-[#EFD16B] w-[106px] h-[187px] rounded-lg shadow-lg z-10">
              <div className="w-[98px] h-[140px] m-1 mb-3 flex items-center justify-center">
                <img 
                  src="/en la calle.svg" 
                  alt="imagen 2" 
            ...
            <div className="flex flex-col mt-[108px] ml-[190px] absolute bg-[#7F9529] w-[106px] h-[187px] rounded-lg shadow-lg z-0 transform rotate-[10deg]">
              <div className="w-[98px] h-[140px] m-1 mb-3 flex items-center justify-center">
                <img 
                  src="/en restaurante.svg" 
                  alt="imagen 3" 
                  className="w-full h-full object-cover rounded"
                />
              </div>
